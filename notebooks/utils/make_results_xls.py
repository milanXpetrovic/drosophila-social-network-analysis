...
# combined_data_reset.to_excel('/home/milky/drosophila-SNA/data/results/xls/local_measures/{TREATMENT}.xlsx', index=False)

path = '/home/milky/drosophila-SNA/data/results/xls/local_measures.xlsx'
