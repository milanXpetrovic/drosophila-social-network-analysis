...
scripts = [
    # "0_preproc_data/0_0_get_normalization.py",
    # "0_preproc_data/0_1_preproc_data.py",
    # "0_preproc_data/0_2_distances_angles_matrix.py",

    # "1_0_create_graphs/1_0_find_interactions.py",
    "1_0_create_graphs/1_1_create_snapshots.py",
